...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('loadFeed works good', function(done) {
    ...
    describe('New Feed Selection', function() {
        var beforeContent = '';
        beforeEach(function(done) {
            beforeContent = $('.entry h2')[0].innerHTML;
            window.loadFeed(2, function() {
                done();
            })
        });
        it('change content success', function(done) {
            expect($('.entry h2')[0].innerHTML).not.toBe(beforeContent);
            done();
        });
    })
}());